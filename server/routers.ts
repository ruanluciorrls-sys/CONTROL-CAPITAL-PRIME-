...
export const appRouter = router({
  ...
  push: router({
    ...
    // Teste: envia AGORA as plataformas que lançam hoje (calendário)
    testPlataformas: protectedProcedure.mutation(async ({ ctx }) => {
      return enviarPlataformasTeste(ctx.user.id);
    }),
